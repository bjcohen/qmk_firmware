 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  `   | BriD | BriU | MCTL | SPOT | DICT |                    | DND  |   7  |   8  |   9  |   0  | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   !  |   @  |   #  |   $  |   %  |-------.    ,-------|   ^  |   &  |   *  |   (  |   )  |   |  |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * | Shift|  =   |  -   |  +   |   {  |   }  |-------|    |-------|   [  |   ]  |   ;  |   :  |   \  | Shift|
...
[_LOWER] = LAYOUT(
  ...
  KC_GRV,  KC_BRID,  KC_BRIU, KC_MCTL,KC_SPOT, KC_DICT,                      KC_DND,    KC_7,    KC_8,    KC_9,    KC_0,  KC_F12,
...
[_RAISE] = LAYOUT(
  ...
  _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), XXXXXXX,  _______,       _______,  KC_HOME, KC_PRVWD, KC_NXTWD, KC_END,   XXXXXXX, _______,
                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
  ...
  QK_BOOT  , XXXXXXX,KC_QWERTY,KC_GALLIUM,CG_TOGG,XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
